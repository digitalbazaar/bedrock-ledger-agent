  ...
  async.auto({
    ...
    createLedgerAgent: ['getLedgerNode', (results, callback) => {
      ...
      const laOptions = {
        ...
        ledgerConfigService: record.ledgerAgent.ledgerConfigService,
...
function _addNewLedgerAgent(actor, ledgerNodeId, options, callback) {
  ...
  // TODO: hard coding service URLs into the record does not allow for config
  // changes to be applied easily. These services should be generated
  // dynamically in the `get` API
