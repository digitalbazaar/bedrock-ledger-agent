...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.get(
    routes.agents, ensureAuthenticated, brRest.when.prefers.ld, brRest.linkedDataHandler({
      get: (req, res, callback) => {
        // authenticated calls should get all public ledgers and specific
        // ledgers
    ...
    (req, res, next) => {
      ...
      async.auto({
        ...
        res.json({
          ...
          owner: results.ledgerAgent.owner,
